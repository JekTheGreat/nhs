...
import {StyleSheet, Dimensions, View, Text, ListView,
	TouchableWithoutFeedback, TouchableNativeFeedback,
	TouchableOpacity, TouchableHighlight, Modal} from "react-native";
...
export default class ModalDropdown extends PureComponent {
  ...
  _renderModal() {
  	...
  	if (showDropdown && this._buttonFrame) {
  		...
  		return (
  			<Modal animationType={animationType} visible transparent onRequestClose={this._onRequestClose} supportedOrientations={["portrait", "portrait-upside-down", "landscape", "landscape-left", "landscape-right"]}>
  				<TouchableWithoutFeedback
  					accessible={accessible}
  					disabled={!showDropdown}
  					onPress={this._onModalPress}>
  					<View style={styles.modal}>
  						<Card style={[styles.dropdown, dropdownStyle, frameStyle]}>
  ...
  _renderRow = (rowData, sectionID, rowID, highlightRow) => {
  	...
  	const row = renderRow ?
  		...
  		(<Text style={[styles.rowText,
  			...
  			highlighted && dropdownTextHighlightStyle]}> {rowData}</Text>);
