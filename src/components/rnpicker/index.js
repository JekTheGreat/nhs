...
export default class RNPickerSelect extends PureComponent {
    ...
    onValueChange(value, index) {
    	...
    	// console.log("value", value, this.props.items[index].item);

    	onValueChange(value, index, this.props.items[index].item);
    ...
    renderAndroidHeadless() {
    	...
    	return (
    		<View style={style.headlessAndroidContainer}>
    			{this.renderTextInputOrChildren()}
    			<Picker style={[
    					Icon ? { backgroundColor: "transparent" } : {backgroundColor: "transparent" },
