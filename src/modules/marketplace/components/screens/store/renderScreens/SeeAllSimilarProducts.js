...
export default class SeeAllSimilarProducts extends React.PureComponent {
    ...
    _renderAllSimilarProducts = ({ item, index }) => {
    ...
    render() {
        const { navigation, marketplace: { postSelectedProducts } } = this.props;
                ...
                <View style={{ padding: 10, width: width, height: height }}>
                    <View style={{ width: "100%", height: "100%" }}>
                        <FlatList
                            ...
                            renderItem={this._renderAllSimilarProducts} />
                    </View>
                </View>
            </ScrollView>
        )
