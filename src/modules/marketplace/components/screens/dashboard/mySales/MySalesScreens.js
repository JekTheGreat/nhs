...
export default class MySalesScreens extends React.PureComponent {
    ...
    _onPress = (item) => {
        ...
        navigation.navigate("MySalesSummary");
    }
    ...
    renderRow = ({ item, index }) => {
        ...
        const productsList = isShowing ? item.items : _.slice(item.items, 0, 2);
        ...
        return (
            <View key={`trans_idx ${index}`} style={{ backgroundColor: "white", borderBottomColor: Colors.grey300, borderBottomWidth: 1 }}>
                ...
                <View style={{ paddingVertical: 10, paddingHorizontal: 15, backgroundColor: Color.bg }}>
                    ...
                    {item.items.length > 2 && <Text onPress={() => this._hideItem(item, index)} style={{ marginTop: 10, textAlign: "center", fontSize: 12, color: Color.colorPrimaryMP }}>
                ...
                <View style={{ paddingHorizontal: 15, paddingVertical: 10, backgroundColor: "white" }}>
                    ...
                    <TouchableOpacity onPress={() => this._onPress(item)}
                        ...
                        <Text style={{ textAlign: "center", fontSize: 12, color: "white" }}>
                            {_.isEqual(item.status, "To Receive") ? "Mark Delivered" : "View Order"}
                        </Text>
                    </TouchableOpacity>
                </View>
