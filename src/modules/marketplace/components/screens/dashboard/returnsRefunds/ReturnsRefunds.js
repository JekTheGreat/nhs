...
import ReturnsRefundsScreens from './ReturnsRefundsScreens';
...
const disputesList = ["All", "Pending", "Approved", "Declined", "Refund", "To Ship", "To Received", "Delivered"];

export default class ReturnsRefunds extends React.PureComponent {
    ...
    renderTab = (name, index) => {
        ...
        if (name === name) {
            ...
            if (name === "All") {
                ...
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Pending".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Pending".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "Approved") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Approved".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Approved".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "Declined") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Declined".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Declined".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "Refund") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Refund".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Refund".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "To Ship") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-To Ship".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-To Ship".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "To Received") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-To Receive".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-To Receive".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            } else if (name === "Delivered") {
                product = _.filter(getSellerReturns.data, transItem => {
                    if (_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Delivered".toUpperCase()) {
                        return transItem;
                    } else if (!_.isEmpty(this.state.input) && transItem.status.toString().toUpperCase() === "Return-Delivered".toUpperCase() && transItem.trackingno.includes(this.state.input)) {
                        return transItem;
                    }
                })
            }
            return <ReturnsRefundsScreens key={index} transactionList={product} tabLabel={name} ref={(e) => this.MSScreens = e} {...this.props} />;
        }
    }
