...
import HeaderImage, {HEADER_IMAGE_HEIGHT} from "../screens/HeaderImage";
...
const ProfileScreen = () => {
	...
	// 					ref={scrollView}
	// 					style={{}} >
	// 					<View style={{height: HEADER_IMAGE_HEIGHT - 50, borderTopLeftRadius: 15, borderTopRightRadius: 15 }}/>
	// 					<View style={{flex: 1, paddingHorizontal: 20, borderTopLeftRadius: 15, borderTopRightRadius: 15, backgroundColor: "white"}}>
