...
export default class DateRange extends Component {
  ...
  render() {
    ...
    const { customStyles = {}, onClose } = this.props;
          ...
          <View style={styles.calendar}>
            <View style={styles.headActionContainer}>
              <TouchableOpacity onPress={this.previousMonth}>
                <Icon name="chevron-left" size={25} color={Color.LightBlue5}/>
              </TouchableOpacity>
              <Text style={{fontWeight: "Roboto", fontSize: 15, color: Color.black2, fontWeight: "bold" }} >
                {this.state.focusedMonth.format("MMMM YYYY")}
              </Text>
              <TouchableOpacity onPress={this.nextMonth}>
                <Icon name="chevron-right" size={25} color={Color.LightBlue5}/>
              </TouchableOpacity>
            </View>
            <Month
