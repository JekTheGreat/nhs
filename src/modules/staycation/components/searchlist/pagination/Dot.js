...
export default class Dot extends Component {
	render() {
		...
		if (!dotIconSizeNotActive){
			dotIconSizeNotActive = 10;
		}
		if (!dotIconSizeActive){
     ...
     * Setup dots icon
     */
		if (_.get(item, "isViewable", false) === true){
			dotIconName = dotIconNameActive;
		} else {
			dotIconName = dotIconNameNotActive;
		}
     ...
     */
		if (_.get(item, "isViewable", false) === true){
			dotIconSize = dotIconSizeActive;
		} else {
			dotIconSize = dotIconSizeNotActive;
		}
		if (_.get(item, "index", true) === true){
			dotIconSize = dotIconSizeEmpty;
		}
		if (_.get(item, "isViewable", false) === true){
			dotIconColor = dotIconColorActive;
		} else {
			dotIconColor = dotIconColorNotActive;
		}
		if (_.get(item, "index", true) === true){
			dotIconColor = dotIconColorEmpty;
		}
		// Setup dots font
		if (_.get(item, "isViewable", false) === true){
			dotFontSize = dotFontSizeActive;
		} else {
			dotFontSize = dotFontSizeNotActive;
		}
		if (_.get(item, "index", true) === true){
			dotFontSize = dotFontSizeEmpty;
		}
		if (_.get(item, "isViewable", false) === true){
			dotTextColor = dotTextColorActive;
		} else {
			dotTextColor = dotTextColorNotActive;
		}
		if (_.get(item, "index", true) === true){
			dotTextColor = dotTextColorEmpty;
		}
       ...
       */
			if (startDotStyle){
				dotStyle = startDotStyle;
			}
			if (startDotIconStyle){
				dotIconStyle = startDotIconStyle;
			}
			if (horizontal === true){
				dotIconName = "chevron-left";
			}
			if (horizontal === false){
				dotIconName = "chevron-up";
			}
			if (startDotIconName){
				dotIconName = startDotIconName;
			}
			if (startDotIconSize){
				dotIconSize = startDotIconSize;
			}
			if (startDotIconFamily){
				dotIconFamily = startDotIconFamily;
			}
			if (startDotIconColor){
				dotIconColor = startDotIconColor;
			}
			if (startDotFontSize){
				dotFontSize = startDotFontSize;
			}
			if (startDotTextHide){
				dotTextHide = true;
			}
			if (startDotTextColor){
				dotTextColor = startDotTextColor;
			}
			// Positioning
			if (startDotIconHide){
				dotIconHide = true;
			...
			onPressDot = (item) => {
				...
				if (startDotOnPress){
					startDotOnPress(item);
				}
			};
		}
		if (EndDot) {
			if (endDotStyle){
				dotStyle = endDotStyle;
			}
			if (!endDotText){
				dotTextHide = true;
			}
			dotIconHide = false;// Reset
			if (endDotIconStyle){
				dotIconStyle = endDotIconStyle;
			}
			if (horizontal === true){
				dotIconName = "chevron-right";
			}
			if (horizontal === false){
				dotIconName = "chevron-down";
			}
			if (endDotIconName){
				dotIconName = endDotIconName;
			}
			if (endDotIconFamily){
				dotIconFamily = endDotIconFamily;
			}
			if (endDotIconSize){
				dotIconSize = endDotIconSize;
			}
			if (endDotIconColor){
				dotIconColor = endDotIconColor;
			}
			if (endDotTextHide){
				dotTextHide = true;
			}
			if (endDotFontSize){
				dotFontSize = endDotFontSize;
			}
			if (endDotTextColor){
				dotTextColor = endDotTextColor;
			}
			// Positioning
			if (endDotIconHide){
				dotIconHide = true;
		...
		const text = (o) => {
				...
				if (_.has(o, "item.paginationDotText")) {
					return o.item.paginationDotText;
				}
             ...
             */
				if (_.isNumber(_.get(o, "index", false))) {
					return ` ${o.index + 1} `;
				}
			...
			icon = (o) => {
				if (_.isUndefined(o, "index") && !EndDot && !startingJumpSize && !endingJumpSize && !StartDot) {
					return;
				}
