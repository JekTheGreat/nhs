...
class FourtheenthScreen extends Component{
	constructor(props){
		super(props);
		this.state = {
      isShowing: "true",
  ...
  onNext = () => {
    ...
    const getInput = _.isEmpty(setInputDetails.fourtheenth) ? 
    {streetNo: null, streetName: null, city:null, states:null, country:null, zipCode:null } : setInputDetails.fourtheenth;
    const error={};
  	...
  	return (
  		<ScrollView style={styles.padH20}>
  			<View style={styles.marT30}>
                  ...
                  {`Note: `}
                    <Text style={{color:Color.Standard2, fontSize: 12, fontWeight:"bold"}}>
...
FourtheenthScreen.propTypes = {
	staycation: PropTypes.object,
};

export default FourtheenthScreen;
