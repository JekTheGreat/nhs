...
export default StyleSheet.create({
	...
	renderBase: {flexDirection: "row", width: "100%", height: 40, alignItems: "center",  borderColor: Color.Standard,
	...
	input: {flex: 1, fontFamily: "Roboto-Light", fontSize: 14, paddingLeft: 5},
