...
class ModalTermsCondition extends React.PureComponent {
    ...
    _iAgree = () => {
        const { agreeInTerms, closeModal } = this.props;
        agreeInTerms();
        closeModal();
    }
                        ...
                        <TouchableWithoutFeedback>
                            <View style={{ height: "80%", width: "90%", backgroundColor: "black" }}>
                                ...
                                <View style={{ marginTop: 10, backgroundColor: "white" }}>
                                    <View style={{ paddingVertical: 10, flexDirection: "row", justifyContent: "space-evenly", alignItems: "center" }}>
                                        <Image
                                    ...
                                    <ScrollView style={{ alignSelf: "center", height: "65%", width: "90%" }}>
                                        <Text style={{ marginVertical: 10, justifyContent: "flex-start", fontFamily: "Roboto-Light", fontSize: 13 }}>
                                            {SampleText}
                                        </Text>
                                    </ScrollView>
