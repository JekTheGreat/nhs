...
class KYCPrimaryID extends React.PureComponent{
	constructor(props){
		super(props);
		this.state = {
			idnumHolder: "",
  ...
  openGalery = (type) => {
	...
	render(){
		const {remittance: {inputDetails, getIdType, 
			isAddNewIDLoading, isTransactionLoad, isCheckingID}} = this.props;
...
KYCPrimaryID.propTypes = {
	actions: PropTypes.object,
	remittance: PropTypes.object,
	login: PropTypes.object,
};

export default KYCPrimaryID;
