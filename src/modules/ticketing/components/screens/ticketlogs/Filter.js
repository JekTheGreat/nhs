...
import {STATUS, FLIGHTTYPE, FILTERTYPE} from "../../../data/TicketLogsData";
...
class Filter extends React.PureComponent{
	...
	render(){
		const {onClose, visible, setFilter, onValueChange, onChangeText, onDayPress, onDone, ticketing: {isGettingLogs}} = this.props;
  					...
  					<ScrollView showsVerticalScrollIndicator={false} style={styles.flex1}>
  						...
  						/>
							...
							<View style={styles.padH15}>
								...
								<Button label="Done" loading={isGettingLogs}
